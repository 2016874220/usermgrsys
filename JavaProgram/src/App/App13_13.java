...
//filename：App13_13.java            GridBagLayout布局管理器的使用
import java.awt.*; 
import javax.swing.*;
...
public static void main(String[] args)
{
  ...
  frm.addCom(jlab,conta,gbc,0,0,1,4,0,0);     //后两个零：缩放比例
  frm.addCom(jta1,conta,gbc,1,0,2,1,5,1);
  frm.addCom(jta2,conta,gbc,1,3,1,1,5,1);
  frm.addCom(jtf,conta,gbc,2,3,1,1,5,0);          //最后一个零：高度在拉伸过程中不变，多余空间给了jta2
