	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a class="active-menu" href="adminAddGoodsServlet"><i class="fa fa-edit"></i>添加商品</a></li>
				<li><a href="adminDeleteGoodsServlet"><i
						class="fa fa-edit"></i>删除商品</a></li>
				<li><a href="adminUpdateGoodsServlet"><i class="fa fa-edit"></i>修改商品信息</a></li>
				<li><a href="adminFindAllBuyinfoServlet"><i
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">
					添加商品页 <small>添加</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="seller.html">系统</a></li>
					<li><a href="adminAddGoodsServlet">添加商品</a></li>
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<%
											...
											v = (Vector<goodsDTO>) session.getAttribute("alladdgoods");
									...
									<td>
									<button type="submit" id="add" onClick="window.location='adminAddGoods.html'">添加</button>
								</div>
							</div>
						</div>
						<!--End Advanced Tables -->
