	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				<li><a href="goodsinfoForSeller.html"><i
				...
				<li><a class="active-menu" href="adminUpdateGoods.jsp"><i
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									<form action="adminUpdateGoodsStepTwoServlet">
											...
											<tbody>
												...
												<tr>
													<td><input type="text" name="gid"
														value=<%=g.getGid()%> readonly unselectable="on"></td>
