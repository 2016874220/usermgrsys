						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									<form action="buyerUpdateBuyinfoStepTwoServlet">
											...
											<tbody>
												...
												<tr>
													<td><input type="text" name="bid"
														value=<%=b.getBid()%> readonly unselectable="on"></td>
													<td><input type="text" name="aid"
														value=<%=b.getAid()%> readonly unselectable="on"></td>
													<td><input type="text" name="gid"
														value=<%=b.getGid()%> readonly unselectable="on"></td>
													<td><input type="text" name="sumnum"
														value=<%=b.getSumnum()%>></td>
