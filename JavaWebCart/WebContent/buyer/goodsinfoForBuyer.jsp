        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        <a class="active-menu" href="goodsinfoForBuyerServlet"><i class="fa fa-table"></i>商品信息</a>
                    </li>
                    <li>
                        <a href="buyerAddBuyinfoServlet"><i class="fa fa-edit"></i>添加购物车</a>
                    </li>
                    <li>
                        <a href="buyerDeleteBuyinfoServlet"><i class="fa fa-edit"></i>删除购物车</a>
                    </li>
                    <li>
		...
		<div id="page-wrapper">
			<div class="header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="goodsinfoForBuyerServlet">商品信息</a></li>
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<%
											...
											v = (Vector<goodsDTO>) session.getAttribute("allgoodsinfoforbuyer");
