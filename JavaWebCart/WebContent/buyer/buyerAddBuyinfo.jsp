	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a class="active-menu" href="buyerAddBuyinfoServlet"><i class="fa fa-edit"></i>添加购物车</a></li>
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">
					添加购物车页 <small>添加</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="buyer.html">系统</a></li>
					<li><a href="buyerAddBuyinfoServlet">添加购物车</a></li>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									...
									<td>
									<button type="submit" id="add" onClick="window.location='buyerAddBuyinfo.html'">添加</button>
								</div>
							</div>
						</div>
						<!--End Advanced Tables -->
